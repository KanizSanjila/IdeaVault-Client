...
import { BookOpen, Menu, X, User, LogOut, LayoutDashboard, Lightbulb } from "lucide-react";
...
export function MainNavbar() {
  ...
  return (
    <nav className={`sticky top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white/70 backdrop-blur-md shadow-sm py-2" : "bg-linear-to-r from-slate-200 to-blue-500 py-4"
      }`}>
        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-extrabold text-2xl tracking-tight bg-linear-to-r from-blue-600 to-cyan-400 text-transparent bg-clip-text">
                IdeaVault 
              </span>
            </Link>
          </div>
            ...
            <div className="relative group">
              <button className="flex items-center gap-3 p-1 rounded-full hover:bg-muted transition-colors border border-transparent hover:border-border">
                <Image
                  width={40}
                  height={40}
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGpsrd7BcoEzUhDd_T4DFyBvF6JFrgHbcvMWVTn6HpAg&s&ec=121691717"
                  alt="avatar"
                  className="w-10 h-10 rounded-full object-cover ring-2 ring-blue-600/10"
                />
                <div className="text-left hidden lg:block">
                  <p className="text-sm font-bold truncate max-w-25">Kaniz Sanjila</p>
              ...
              <div className="absolute right-0 top-12 w-56 bg-white border border-slate-200 rounded-2xl shadow-2xl hidden group-hover:flex flex-col py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="px-4 py-3 border-b border-slate-100">
                  ...
                  <p className="text-xs truncate text-slate-500">kanizsm13@gmail.com</p>
                </div>
