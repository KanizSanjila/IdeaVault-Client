...
import { fetchFeaturedData } from "@/lib/data";


const FeaturedCourses = async () => {
     const courses = await fetchFeaturedData()
//    console.log(courses)
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-500 max-w-xl">
                           Discover innovative startup ideas shared by creative minds around the world. 
                        </p>
                    </div>
                    <Button
                        variant="flat"
